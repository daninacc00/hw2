...
function loadUserSettings() {
    ...
    fetch("/api/account/profile")
        ...
        .then(function (data) {
            ...
            if (data.success) {
                ...
                if (data.data.settings) {
                    document.getElementById("newsletter_enabled").checked =
                        data.data.settings.newsletter_enabled || false;
                    document.getElementById("notifications_enabled").checked =
                        data.data.settings.notifications_enabled || false;
                }
            } else {
                showAlert(
                    data.error ||
        ...
        .catch(function (error) {
            ...
            showAlert(
                error.message || "Errore nel caricamento delle impostazioni",
                "error"
            );
        });
}
        ...
        .then(function (data) {
            ...
            if (data.success) {
                ...
                showAlert(
                    data.error ||
                        data.message ||
                        "Errore sconosciuto durante l'aggiornamento",
                    "error"
                );
            }
        })
        ...
        .then(function (data) {
            ...
            if (data.success) {
                ...
                showAlert(
                    data.error ||
                        data.message ||
                        "Errore sconosciuto durante l'aggiornamento della password",
                    "error"
                );
            }
        })
