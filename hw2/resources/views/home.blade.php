...
<div id="experience-wrapper">
        ...
        <div class="article-container">
            <article class="article-card">
                ...
                <div class="article-caption">
                    ...
                    <h3>Vomero 18</h3>
                    <a class="button" href="/shop?gender=men&section=shoes">Acquista</a>
                </div>
            </article>
    ...
    <div class="menu">
        <div class="menu-column">
            <h4>Scarpe</h4>
            <ul class="menu-list">
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=shoes">Scarpe da running
                        nere</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=shoes">Scarpe da running
                        bianche</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=shoes">Scarpe Nike
                        P-6000</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=shoes">Nike Initiator</a>
                </li>
            </ul>
        </div>
        <div class="menu-column">
            <h4>Abbigliamento</h4>
            <ul class="menu-list">
                <li class="list-item"><a class="link-item" href="/shop?gender=women&section=wear">Pantaloni da
                        yoga</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=women&section=wear">Pantaloni jogger
                        Tech Fleece</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=women&section=wear">Tech Fleece</a>
                </li>
            </ul>
        </div>
        <div class="menu-column">
            <h4>Bambini</h4>
            <ul class="menu-list">
                <li class="list-item"><a class="link-item" href="/shop?gender=kids&section=shoes">Scarpe nere per
                        bambina</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=kids&section=shoes">Scarpe nere
                        kids</a></li>
            </ul>
        </div>
        <div class="menu-column">
            <h4>In evidenza</h4>
            <ul class="menu-list">
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=wear&sport=football">Squadre di
                        calcio</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=wear&sport=football">Calcio</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=wear&sport=football">Nike
                        Inghilterra</a></li>
                <li class="list-item"><a class="link-item" href="/shop?gender=men&section=wear&sport=football">Nike Run Club</a>
                </li>
            </ul>
        </div>
    </div>
